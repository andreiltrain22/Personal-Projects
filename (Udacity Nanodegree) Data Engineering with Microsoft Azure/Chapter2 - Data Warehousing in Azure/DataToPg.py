...
########################################
host = "divvydb.postgres.database.azure.com"
user = "andreil"
password = "Ofutpemataincur37"
...
cursor = conn.cursor()
cursor.execute('DROP DATABASE IF EXISTS divvydb')
cursor.execute("CREATE DATABASE divvydb")
...
table = "payment"
filename = path + '/data/payments.csv'
...
table = "station"
filename = path + '/data/stations.csv'
